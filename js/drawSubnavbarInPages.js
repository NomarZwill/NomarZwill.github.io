...
header.innerHTML = `<a class="name header-font-set" href="../index.html">АРТЁМ МЕЩЕРЯКОВ</a>

<input class="droplist icons-32" type="image" src="../img/list-icon.svg"></input>`;
...
navbarList.innerHTML = `<a class="navbar-list__item navbar-list--font-set" href="list-of-content.html#projects">ПРОЕКТЫ</a>
<a class="navbar-list__item navbar-list--font-set" href="list-of-content.html#art">ТВОРЧЕСТВО</a>`;
